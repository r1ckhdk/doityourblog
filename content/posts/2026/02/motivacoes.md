...
tags = ["selfhosting", "hugo", "blog", "algoritmo", "enshittification"]
+++


Bom dia, tudo bão?

Ainda estou arrumando a "casa" aqui, ou seja, me fodendo pra achar as opções certas e zilhões de configurações do [Hugo](https://gohugo.io/) (gerador de site estático). Mas se eu for começar a escrever só depois que o layout tiver do meu gosto, aí fodeu, né?

<!--more-->

Mas por que caralhos eu tô escrevendo um blog em 2026?
...
[![SHIT DUDE!](/img/shit.png)](/img/shit.png)
...
Por fim, a gota final de inspiração veio [desse vídeo do Luke Smith](https://www.youtube.com/watch?v=bdKZVIGRAKQ), onde basicamente ele fala pra você deixar de ser um servo camponês nas terras da Meta e se tornar dono do seu terreno na web.

Tá bom já, né?

Em próximos posts talvez eu fale mais sobre merdificação, objetivos que tenho com o blog, como eu estou hosteando esse site etc.

Ahh, faltou falar do nome né.

Isso é simples.

Eu até poderia ficar falando de um *ethos* do faça você mesmo e como isso também se expressa como uma rejeição ao estado em que a web se encontra hoje... Mas enfim, já tá bem explícito isso.

Quando eu vi que o domínio tava livre pra compra, não quis mais gastar neurônios tentando bolar outro nome. Sendo bom ou ruim, vai ficar esse nome aí por tempo indeterminado.

Mas sim, é só um trocadilho com o termo [DIY (do it yourself)](https://en.wikipedia.org/wiki/Do_it_yourself).

Afinal, eu mesmo estou fazendo esse blog e servindo ele pra web (é... não completamente, mas isso é assunto pra outra hora).
